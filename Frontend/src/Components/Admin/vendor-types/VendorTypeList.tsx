          ...
          <table className="w-full text-left table-auto min-w-max pl-20">
            ...
            <tbody>
              {vendorType.map((type,index)=>(
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  <div className="w-max">
                  <Button size="sm" placeholder={undefined} className="mr-2"  onClick={() => handleEdit(type._id)}>Edit</Button>
                  <Button size="sm" placeholder={undefined} variant="outlined" onClick={()=>handleDeleteModal(type._id)}>Delete</Button>
                  </div>
                </td>
              </tr>
              ))}
