...
const BookingTable = () => {
  ...
  return (
    ...
    <div className=" border-4 border-gray-500 rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
